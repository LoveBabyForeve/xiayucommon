 ...
 * @Author: 下雨了
 * @CreateDate: 2020-12-03 10:56
 * @UpdateUser: 更新者
 * @UpdateDate: 2020-12-11 20:08:44
 * @UpdateRemark: 已弃用 统一使用LogcatUtils
 * @Version: 1.0
 */
@Deprecated
public class BlockMonitorUtils {
    public static final String TAG = "BlockMonitorUtils";
