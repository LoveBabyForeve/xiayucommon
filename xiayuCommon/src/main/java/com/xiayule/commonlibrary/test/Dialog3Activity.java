package com.xiayule.commonlibrary.test;
 ...
 * @Author: 下雨了
 * @CreateDate: 2020/7/28 11:36
 * @UpdateUser: 更新者
 * @UpdateDate: 2020/7/28 11:36
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
...
public class Dialog3Activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog3_activity_main);
        isAlive = true;
        initViews();
        initDatas();
        setEvents();
    ...
    private void setEvents() {
        ...
        btnFullScreenDialogLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FullScreenDialog
                        .show(me, R.layout.dialog3_layout_full_login, new FullScreenDialog.OnBindView() {
                            @Override
        ...
        btnFullScreenDialogWebPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FullScreenDialog.show(me, R.layout.dialog3_layout_full_webview, new FullScreenDialog.OnBindView() {
                    @Override
        ...
        btnCustomDialog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CustomDialog.build((AppCompatActivity) me, R.layout.dialog3_layout_custom_dialog, new CustomDialog.OnBindView() {
                    @Override
        ...
        btnCustomMessageDialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MessageDialog.show(me, "提示", "这个窗口附带自定义布局", "知道了")
                        .setCustomView(R.layout.dialog3_layout_custom, new MessageDialog.OnBindView() {
                            @Override
        ...
        btnCustomInputDialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                InputDialog.show(me, "提示", "这个窗口附带自定义布局", "知道了")
                        .setCustomView(R.layout.dialog3_layout_custom, new InputDialog.OnBindView() {
                            @Override
...
//                        .show();
        ...
        btnCustomBottomMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                }).setCustomView(R.layout.dialog3_layout_custom, new BottomMenu.OnBindView() {
                    @Override
        ...
        btnCustomNotification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Notification.show(me, "提示", "提示信息", R.mipmap.dialog3_ico_wechat).setCustomView(R.layout.dialog3_layout_custom_notification_button, new Notification.OnBindView() {
                    @Override
...
//                });
        ...
        btnShareDialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (DialogSettings.style == DialogSettings.STYLE.STYLE_IOS) {
                    itemList.add(new ShareDialog.Item(me, R.mipmap.dialog3_img_email_ios, "邮件"));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.dialog3_img_qq_ios, "QQ"));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.dialog3_img_wechat_ios, "微信"));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.dialog3_img_weibo_ios, "微博"));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.dialog3_img_memorandum_ios, "添加到“备忘录”"));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.dialog3_img_remind_ios, "提醒事项"));
                } else {
                    itemList.add(new ShareDialog.Item(me, R.mipmap.dialog3_img_email_material, "邮件"));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.dialog3_img_qq_material, "QQ"));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.dialog3_img_wechat_material, "微信"));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.dialog3_img_weibo_material, "微博"));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.dialog3_img_hangout_material, "环聊"));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.dialog3_img_remind_material, "Keep"));
                }
        ...
        btnNotify.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Notification.show(me, "提示", "提示信息", R.mipmap.dialog3_ico_wechat).setOnNotificationClickListener(new OnNotificationClickListener() {
                    @Override
                    public void onClick() {
        ...
        grpStyle.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.rdo_ios) {
                    DialogSettings.style = DialogSettings.STYLE.STYLE_IOS;
                } else if (checkedId == R.id.rdo_kongzue) {
                    DialogSettings.style = DialogSettings.STYLE.STYLE_KONGZUE;
                } else if (checkedId == R.id.rdo_material) {
